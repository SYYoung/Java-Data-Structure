...
public class NewTrieSet implements Iterable<String> {
    ...
    public static void main(String[] args) {
        ...
        StdOut.println("longestPrefixOf(\"WOMANS\"):");
        StdOut.println(set.longestPrefixOf("WOMANS"));
        StdOut.println();


        StdOut.println("keysWithPrefix(\"WO\"):");
        for (String s : set.keysWithPrefix("WO"))
            StdOut.println(s);
        StdOut.println();

        StdOut.println("keysThatMatch: YOU ");
        for (String s : set.keysThatMatch("YOU"))
            StdOut.println(s);

        StdOut.println("Is WO prefix available" + set.isPrefixValid("WO"));
