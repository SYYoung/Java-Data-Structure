...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		ArrayList<Integer> totalDegree = new ArrayList<Integer>();
		for (int v = 0; v < numVertices; v++) {
			totalDegree.add(this.getNeighbors(v).size() + this.getInNeighbors(v).size());
			Collections.sort(totalDegree, Collections.reverseOrder());
		}
		return totalDegree;
	}
	...
	public static void main (String[] args) {
		...
		System.out.println("From AdjList:");
		System.out.println(graphFromFile);
		
		System.out.println("Observe all degrees are <= 15.");
		System.out.println("****");
		...
		System.out.println("From AdjMatrix");
